...
namespace WpfVideo89.GestionPedidosDataSetTableAdapters {
...
SELECT Id, seccion, fecha, nombreArticulo, paisOrigen, precio FROM articulo WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::WpfVideo89.Properties.Settings.Default.GestionPedidosConnectionString;
        }
    ...
    public partial class clientesTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.DeleteCommand.Connection = this.Connection;
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[clientes] WHERE (([Id] = @Original_Id) AND ((@IsNull_nombre = 1 AND [nombre] IS NULL) OR ([nombre] = @Original_nombre)) AND ((@IsNull_direccion = 1 AND [direccion] IS NULL) OR ([direccion] = @Original_direccion)) AND ((@IsNull_poblacion = 1 AND [poblacion] IS NULL) OR ([poblacion] = @Original_poblacion)) AND ((@IsNull_telefono = 1 AND [telefono] IS NULL) OR ([telefono] = @Original_telefono)))";
            this._adapter.DeleteCommand.CommandType = global::System.Data.CommandType.Text;
            this._adapter.DeleteCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Original_Id", global::System.Data.SqlDbType.Int, 0, global::System.Data.ParameterDirection.Input, 0, 0, "Id", global::System.Data.DataRowVersion.Original, false, null, "", "", ""));
    ...
    public partial class pedidosTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[pedidos] ([idCliente], [fechaPedido], [formaPago]) VALUES (@id" +
                ...
                "rmaPago FROM pedidos WHERE (idPedido = SCOPE_IDENTITY())";
            this._adapter.InsertCommand.CommandType = global::System.Data.CommandType.Text;
            ...
            this._adapter.UpdateCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.UpdateCommand.Connection = this.Connection;
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[pedidos] SET [idCliente] = @idCliente, [fechaPedido] = @fechaPedido, [formaPago] = @formaPago WHERE (([idPedido] = @Original_idPedido) AND ([idCliente] = @Original_idCliente) AND ((@IsNull_fechaPedido = 1 AND [fechaPedido] IS NULL) OR ([fechaPedido] = @Original_fechaPedido)) AND ((@IsNull_formaPago = 1 AND [formaPago] IS NULL) OR ([formaPago] = @Original_formaPago)));
